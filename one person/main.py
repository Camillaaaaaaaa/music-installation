...
class Main:
    def __init__(self):
        ...
        self.height_start = 270
        self.height_stop = self.screen_height - 390
    ...
    def start_camera(self):
        ...
        with self.mp_holistic.Holistic(
            ...
            while cap.isOpened():
                ...
                results = self.video_analysis.analyze(image, holistic)
                frame_height, frame_width, _ =image.shape

                instrument = (self.current_instrument)

                if results.pose_landmarks:
                    head_pos = self.video_analysis.update_head_pos(frame_height, frame_width, 0,
                                                                   0,
                                                                   results)
