...
class VideoAnalysis:
    ...
    def update_head_pos(self, image_height, image_width,results):
        x_coodinate = results.keypoints[2].x * image_width
        y_coodinate = results.keypoints[2].y * image_height
    ...
    def get_face_size(self, image_height, image_width, results):
        return int(results.bounding_box.width/2)
